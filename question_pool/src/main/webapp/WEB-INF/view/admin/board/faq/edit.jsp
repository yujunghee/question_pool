	...
	$(function(){
		$("#frm").ajaxForm({
			...
			success:function(res) {
				alert('정상적으로 수정되었습니다.');
				location.href='view.do?faq_no=${data.faq_no}';
			}
		});
	});
</script>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 관리 기본내용입니다.">
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="10">
											<input type="text" id="faq_title" name="faq_title" class="w100" title="제목을 입력해주세요" value="${data.faq_title }"/>	
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="">내용</label></th>
										<td colspan="10">
											<textarea id="faq_content" name="faq_content" title="내용을 입력해주세요" style="width:100%;">${data.faq_content }</textarea>	
										</td>
									</tr>
								</tbody>
							</table>
