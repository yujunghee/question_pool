	...
	<div id="canvas">		
		...
		<div id="container" style="width:100%;">
				...
				<div class="pageTitle">
					<h2>FAQ</h2><br><br>  
					<h3>
						[Ladder Up] 고객님들께서 자주 물으시는 질문과 답변을 모았습니다. <br> 원하시는 내용이 없으면 'Q&A'를 이용하여 문의해주시기 바랍니다.						
					</h3><br>
					<div class="btn">
						<div class="writebtn">
				...
				<div class="con">
					...
					<div class="bbs">					
					<table>								
						<tr id="answer" colspan="10" style="text-align: left; display: none; background-color: #eddae7;"></tr>
					</table>				
						<div class="list">
							<!-- search --> 							
